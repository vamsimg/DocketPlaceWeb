...
namespace DocketPlace.Business.Framework
{
    ...
    public partial class SqlHelperBase : IDisposable
    {
        ...
        {
            return Execute(command, commandType, parameterList, 30);
        }
        ...
        {
            return ExecuteDataSet(command, commandType, parameterList, 30);
        }
        ...
        {
            return ExecuteDataTable(command, commandType, parameterList, 30);
        }
        ...
        {
            return ExecuteDataReader(command, commandType, parameterList, CommandBehavior.Default, 30);
        }
        ...
        {
            return ExecuteDataReader(command, commandType, parameterList, behavior, 30);
        }
        ...
        {
            return ExecuteScalar(command, commandType, parameterList, 30);
        }
        ...
        {
            return ExecuteXmlReader(command, commandType, parameterList, 30);
        }
