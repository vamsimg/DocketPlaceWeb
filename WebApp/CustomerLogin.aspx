<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="WebApp.CustomerLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
	...
	<br />
	Forgot your password ? <asp:HyperLink ID="ForgottenPasswordHyperLink" runat="server" NavigateUrl="/ResetCustomerPassword.aspx"> Click here to obtain a new one.</asp:HyperLink>	 
