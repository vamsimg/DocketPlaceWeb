<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="ResetCustomerPassword.aspx.cs" Inherits="WebApp.ResetCustomerPassword" %>



<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">

	<h1>Customer Password Reset</h1>			
