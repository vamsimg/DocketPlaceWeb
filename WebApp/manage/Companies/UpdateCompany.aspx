<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="UpdateCompany.aspx.cs" Inherits="WebApp.manage.Companies.UpdateCompany" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
	...
	<div class="brclear"></div> 
	<br />
	<asp:Label ID="UpdateCompanyErrorLabel" runat="server" Text="" CssClass="errorMessage"></asp:Label>
	
	<h2>Mailchimp Integration</h2>

	<span class="leftLabel">Mailchimp API Key: </span>
		<asp:TextBox ID="MailchimpTextBox" runat="server" CssClass="textField"  Columns="100" ValidationGroup="Mailchimp"></asp:TextBox>
		<asp:RequiredFieldValidator ID="MailchimpTextBoxRequiredFieldValidator" runat="server" ControlToValidate="MailchimpTextBox"  CssClass="errorMessage" Display="Dynamic" ErrorMessage="* Please enter a Mailchimp API Key" ValidationGroup="Mailchimp"></asp:RequiredFieldValidator>
	
	<div class="brclear"></div> 
	
	<span class="leftLabel">Mailchimp Master List ID: </span>
		<asp:Label ID="MCMasterListLabel" runat="server" CssClass="textField"></asp:Label>	
	
	<div class="brclear"></div> 
	
	<asp:Button ID="MailchimpButton" runat="server" Text="Update Mailchimp" onclick="MailchimpButtonButton_Click"/>
	
	<div class="brclear"></div> 
	<br />
	<asp:Label ID="MailchimpErrorLabel" runat="server" Text="" CssClass="errorMessage"></asp:Label>
