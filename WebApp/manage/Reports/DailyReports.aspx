<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="True" CodeBehind="DailyReports.aspx.cs" Inherits="WebApp.manage.Reports.DailyReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
	...
	<asp:Chart ID="HourlyCountChart" runat="server">
		<Titles><asp:Title Text="Hourly Number of Sales"></asp:Title></Titles>	
		<Series>
	...
	<asp:Chart ID="HourlyRevenueChart" runat="server">
		<Titles><asp:Title Text="Hourly Total Revenue"></asp:Title></Titles>	
		<Series>
			<asp:Series Name="Series1">
		</asp:Series>
		</Series>
	...
	<asp:Chart ID="HourlyAverageSalesChart" runat="server">
		<Titles><asp:Title Text="Hourly Average Sale"></asp:Title></Titles>	
		<Series>
			<asp:Series Name="Series1">
		</asp:Series>
		</Series>
     ...
     <span class="leftLabel">Net Profits (no tax): </span> <asp:Label ID="ProfitsLabel" runat="server" Text=""  CssClass="textField"></asp:Label>

     <div class="brclear"></div>


	<asp:GridView ID="DepartmentsSummaryGridView" runat="server" AutoGenerateColumns="False" EnableViewState="false">
		<Columns>						
               <asp:BoundField DataField="department" HeaderText="Department"/>              
			<asp:BoundField DataField="items_sold" HeaderText="# Items Sold" SortExpression="items_sold" />		
               <asp:BoundField DataField="total_sales" HeaderText="Total Sales" SortExpression="total_sales" DataFormatString="{0:C0}" />		               
               <asp:BoundField DataField="net_profits" HeaderText="Net Profits" SortExpression="net_profits" DataFormatString="{0:C0}" />		
		</Columns>
	</asp:GridView>
     
     <h3>Department and Category Summary</h3>	

     <asp:GridView ID="DepartmentCategorySummaryGridView" runat="server" AutoGenerateColumns="False" EnableViewState="false">
		<Columns>						
               <asp:BoundField DataField="department" HeaderText="Department"/>              
